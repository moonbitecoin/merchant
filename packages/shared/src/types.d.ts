...
export type MoneyBigInt = bigint & {
...
export type TransactionStatus = 'pending' | 'underpaid' | 'confirmed' | 'reverted' | 'late' | 'failed';
export type Transaction = {
    id: TransactionID;
    productId: ProductID;
    storeId: StoreID;
    amount: MoneyBigInt;
    expectedAmount: MoneyBigInt;
    platformFeeAmount: MoneyBigInt;
    merchantAmount: MoneyBigInt;
...
export type AuditLogAction = 'merchant.login' | 'merchant.logout' | 'merchant.2fa_enable' | 'store.create' | 'store.update' | 'product.create' | 'product.update' | 'product.delete' | 'api_key.create' | 'api_key.revoke' | 'payout.request' | 'wallet.update' | 'webhook.create' | 'webhook.update';
